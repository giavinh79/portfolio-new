...
export const PROJECTS_DATA = {
  ...
  LEGO: {
    title: 'Lego',
    description:
      'This group engineering project is composed of many different modules (frontend, backend, data extractor module, and reinforcement environment). I worked on the front-end application for the project demo, the data extraction module, and the machine learning environment\'s reward function. The image above shows the basic <strong>React.js</strong> frontend demo skeleton and can be found in this <a class="description-link" target="_blank" href="https://github.com/GV79/lego-ml-frontend" rel="noopener noreferrer" aria-label="Lego Frontend">repository</a> and was created using <strong>React.js</strong> and <strong>Material-UI</strong>. The data extraction module was written in <strong>Node.js</strong>. The web scraping and API calling code can be found in this <a class="description-link" target="_blank" href="https://github.com/GV79/lego-data-collection" rel="noopener noreferrer" aria-label="Lego Data Scraper">repository</a>. Finally, the build stability reward function I designed for the reinforcement learning environment was programmed in <strong>Python 3</strong>. Code for this module along with the Jupyter Notebook can be found in this <a class="description-link" target="_blank" href="https://github.com/GV79/lego-build-stability" rel="noopener noreferrer" aria-label="Lego Build Stability function">repository.</a>',
