...
export const PROJECTS_DATA = {
  ...
  LEGO: {
    title: 'Lego',
    description:
      'This group engineering project is composed of many different modules (frontend, backend, data extractor module, and reinforcement environment). I worked on the front-end application for the project demo, the data extraction module, and the machine learning environment\'s reward function. The image above shows the basic <strong>React.js</strong> frontend demo skeleton and can be found in this <a class="description-link" target="_blank" href="https://github.com/giavinh79/lego-ml-frontend" rel="noopener noreferrer">repository</a> and was created using <strong>React.js</strong> and <strong>Material-UI</strong>. The data extraction module was written in <strong>Node.js</strong>. The web scraping and API calling code can be found in this <a class="description-link" target="_blank" href="https://github.com/giavinh79/lego-data-collection" rel="noopener noreferrer">repository</a>. Finally, the build stability reward function I designed for the reinforcement learning environment was programmed in <strong>Python 3</strong>. Code for this module along with the Jupyter Notebook can be found in this <a class="description-link" target="_blank" href="https://github.com/giavinh79/lego-build-stability" rel="noopener noreferrer">repository.</a>',
  ...
  'CHAT-CLIENT': {
    description:
      '<span style="font-weight: bold">Chat Client:</span> This is a <a class="description-link" target="_blank" rel="noopener noreferrer" href="https://obscure-harbor-66476.herokuapp.com/">chat client </a> web app I made for fun. It was created with <span style="color: #32738c">HTML</span>, <span style="color: #32738c">CSS (Bootstrap)</span>, <span style="color: #32738c">JavaScript (jQuery)</span>, <span style="color: #32738c">Node.js</span>, <span style="color: #32738c">Express</span>, and <span style="color: #32738c">Socket.IO</span>. The chat works for anonymous users and also has account functionality via <span style="color: #32738c">mongoDB</span>. The DB key is exposed on the GitHub repo so test with username: \'user\' and password: \'default\'. Code can be found <a class="description-link" target="_blank" href="https://github.com/giavinh79/chatclient" rel="noopener noreferrer">here.</a> Due to hosting settings, the website will initially take some time to load.',
    numImages: 2,
